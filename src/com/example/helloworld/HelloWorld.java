...
public class HelloWorld {
     ...
     */
    private static List<Integer> dualIteratingExclusiveList(Iterator<Integer> itA, Iterator<Integer> itB, int valA,
                                                            int valB, List<Integer> result) {
    ...
    /**
     * This helper function while traverse the nodes of an Iterator until the value at the current node no longer
     * matches the starting value
     *
     * @param it            iterator to traverse to the next node
